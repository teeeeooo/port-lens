...
const EN = {
  ...
  previouslyManagedNote: "Recognized as an App previously started by Port Lens. Stop / Restart remain unavailable after Port Lens itself restarts.",
...
const KO: Record<MessageKey, string> = {
  ...
  previouslyManagedNote: "이전에 Port Lens가 시작한 App으로 인식했습니다. Port Lens 자체를 재실행한 뒤에는 안전을 위해 Stop / Restart는 사용할 수 없습니다.",
